...
namespace SlimeGame.Content.UI
{
    ...
    {
        // Reference to the text label that  displays the sliders title
        ...
        // Create a new Optionsslider instance using graphics from the specific texture atlas
        ...
        // Automatically focuses the slider when the users interacts with it
        ...
        {
            // Calculate the ration of the current value within its range
            double ratio = (Value - Minimum) / (Maximum - Minimum);

            // Update the fill rectangle as a percentage
